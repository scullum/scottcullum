...
export default function WorkDetailPage({ params }: { params: WorkDetailPageParams }) {
  ...
  return (
    <div className="py-12">
      <Link href="/work" className="inline-flex items-center font-mono text-accent hover:underline mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <GlitchCard>
          ...
          <p>
            Every project comes with unique challenges. For {project.title}, we needed to balance technical constraints
            with ambitious business goals while maintaining a focus on user experience.
          </p>
        </GlitchCard>
        ...
        <GlitchCard>
          ...
          <p>
            I took a strategic yet hands-on approach, working closely with stakeholders to understand the core needs and
            develop solutions that addressed both immediate requirements and long-term vision.
          </p>
        </GlitchCard>
        ...
        <GlitchCard>
          ...
          <p>
            The result was a solution that not only met technical requirements but also aligned with business objectives
            and delivered a compelling user experience that drove measurable results.
          </p>
        </GlitchCard>
      </div>
      ...
      <div className="mb-12">
        ...
        <p className="text-lg">
          ...
          to create a cohesive solution that addressed complex challenges while maintaining clarity of purpose.
        </p>
      </div>
      ...
      <div className="mb-12">
        ...
        <ul className="space-y-4">
          <li className="flex items-start">
            ...
            <span>Strategic direction and technical leadership throughout the project lifecycle</span>
          </li>
          <li className="flex items-start">
            <span className="text-accent mr-2">→</span>
            <span>Cross-functional collaboration to align technical implementation with business objectives</span>
          </li>
          <li className="flex items-start">
            <span className="text-accent mr-2">→</span>
